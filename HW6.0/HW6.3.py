...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 23:39:44 2021
...
X1=X1.reshape(50000,10,1,1); #print(X[0])
...
####  Use this trained AE to perform anomaly detection using the Cifar100 data (as anomalies)

from keras.datasets import cifar100
(X_, Y_), (test_images_, test_labels_)  = cifar100.load_data()

#NORMALIZE AND RESHAPE
X_=X_/np.max(X_) 
test_images_=test_images_/np.max(test_images_) 
#X_=X_.reshape(50000,3072,1,1)
#test_images_=test_images_.reshape(10000,3072,1,1); 
...
#RESHAPE
x_sorted = x_sorted.reshape(550,32,32,3)
X1_=model.predict(x_sorted) 
X1_=X1_.reshape(550,10,1,1)
