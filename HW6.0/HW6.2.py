...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 21:08:28 2021
...
X1=X1.reshape(60000,10,1); #print(X[0])
...
test_images_=test_images_.reshape(10000,28,28,1); 
...
#RESHAPE
x_sorted = x_sorted.reshape(550,28,28,1)
